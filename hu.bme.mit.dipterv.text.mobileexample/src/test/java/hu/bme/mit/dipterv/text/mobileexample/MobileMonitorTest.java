...
public class MobileMonitorTest implements ISystem {
	...
	@Test
	public void testMobileScenarioNeverStarts() {
		resetValues();
		Specification specification = new Specification();
		specification.listAutomatas();
		IClock clock = new Clock();
		...
		monitor.update("user", "device", "randomMessage", new String[] {}, true);
		monitor.update("device", "device", "accessFile", new String[] {}, true);
		monitor.update("device", "user", "getMusic", new String[] {}, true);
		monitor.update("someone", "else", "message", new String[] {}, true);
		monitor.update("device", "db", "retrieveData", new String[] {}, true);
		monitor.update("device", "db", "retrieveInformation", new String[] {}, true);
		monitor.update("db", "device", "generateDocuments", new String[] {}, true);

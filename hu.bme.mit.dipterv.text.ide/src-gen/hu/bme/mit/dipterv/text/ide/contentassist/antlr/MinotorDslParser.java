 ...
 */
package hu.bme.mit.dipterv.text.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import hu.bme.mit.dipterv.text.ide.contentassist.antlr.internal.InternalMinotorDslParser;
import hu.bme.mit.dipterv.text.services.MinotorDslGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class MinotorDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MinotorDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MinotorDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBinaryLogicalExpressionAccess().getAlternatives(), "rule__BinaryLogicalExpression__Alternatives");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getAlternatives(), "rule__EqualsBooleanExpression__Alternatives");
			...
			builder.put(grammarAccess.getResetClockAccess().getGroup(), "rule__ResetClock__Group__0");
			builder.put(grammarAccess.getClockConstraintAccess().getGroup(), "rule__ClockConstraint__Group__0");
			builder.put(grammarAccess.getClockConstraintExpressionAccess().getGroup_0(), "rule__ClockConstraintExpression__Group_0__0");
			...
			builder.put(grammarAccess.getEqualsExpressionAccess().getGroup(), "rule__EqualsExpression__Group__0");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getGroup_0(), "rule__EqualsBooleanExpression__Group_0__0");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getGroup_1(), "rule__EqualsBooleanExpression__Group_1__0");
			builder.put(grammarAccess.getGreaterThanExpressionAccess().getGroup(), "rule__GreaterThanExpression__Group__0");
			builder.put(grammarAccess.getLesserThanExpressionAccess().getGroup(), "rule__LesserThanExpression__Group__0");
			builder.put(grammarAccess.getNotLogicalExpressionAccess().getGroup(), "rule__NotLogicalExpression__Group__0");
			...
			builder.put(grammarAccess.getMessageAccess().getCAssignment_13_1(), "rule__Message__CAssignment_13_1");
			builder.put(grammarAccess.getMessageAccess().getConstraintexpAssignment_13_3(), "rule__Message__ConstraintexpAssignment_13_3");
			builder.put(grammarAccess.getMessageAccess().getResetinconstraintAssignment_13_5(), "rule__Message__ResetinconstraintAssignment_13_5");
			builder.put(grammarAccess.getMessageAccess().getClockconstraintAssignment_14(), "rule__Message__ClockconstraintAssignment_14");
			builder.put(grammarAccess.getMessageAccess().getCConstraintAssignment_16(), "rule__Message__CConstraintAssignment_16");
			builder.put(grammarAccess.getMessageAccess().getResetclockAssignment_18(), "rule__Message__ResetclockAssignment_18");
			builder.put(grammarAccess.getResetClockAccess().getClockAssignment_1(), "rule__ResetClock__ClockAssignment_1");
			...
			builder.put(grammarAccess.getClockConstraintExpressionAccess().getNotAssignment_0_0(), "rule__ClockConstraintExpression__NotAssignment_0_0");
			builder.put(grammarAccess.getClockConstraintExpressionAccess().getLclockconstraintAssignment_0_2(), "rule__ClockConstraintExpression__LclockconstraintAssignment_0_2");
			builder.put(grammarAccess.getClockConstraintExpressionAccess().getLclockconstraintAssignment_1_0(), "rule__ClockConstraintExpression__LclockconstraintAssignment_1_0");
			builder.put(grammarAccess.getClockConstraintExpressionAccess().getRclockconstraintAssignment_1_2(), "rule__ClockConstraintExpression__RclockconstraintAssignment_1_2");
			...
			builder.put(grammarAccess.getAndExpressionAccess().getLhsAssignment_2(), "rule__AndExpression__LhsAssignment_2");
			builder.put(grammarAccess.getAndExpressionAccess().getRhsAssignment_4(), "rule__AndExpression__RhsAssignment_4");
			builder.put(grammarAccess.getOrExpressionAccess().getLhsAssignment_2(), "rule__OrExpression__LhsAssignment_2");
			builder.put(grammarAccess.getOrExpressionAccess().getRhsAssignment_4(), "rule__OrExpression__RhsAssignment_4");
			builder.put(grammarAccess.getEqualsExpressionAccess().getLhsAssignment_2(), "rule__EqualsExpression__LhsAssignment_2");
			builder.put(grammarAccess.getEqualsExpressionAccess().getRhsAssignment_4(), "rule__EqualsExpression__RhsAssignment_4");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getLhsAssignment_0_2(), "rule__EqualsBooleanExpression__LhsAssignment_0_2");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getRhsAssignment_0_4(), "rule__EqualsBooleanExpression__RhsAssignment_0_4");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getLhsAssignment_1_2(), "rule__EqualsBooleanExpression__LhsAssignment_1_2");
			builder.put(grammarAccess.getEqualsBooleanExpressionAccess().getRhsAssignment_1_4(), "rule__EqualsBooleanExpression__RhsAssignment_1_4");
			builder.put(grammarAccess.getGreaterThanExpressionAccess().getLhsAssignment_2(), "rule__GreaterThanExpression__LhsAssignment_2");
			builder.put(grammarAccess.getGreaterThanExpressionAccess().getRhsAssignment_4(), "rule__GreaterThanExpression__RhsAssignment_4");
			builder.put(grammarAccess.getLesserThanExpressionAccess().getLhsAssignment_2(), "rule__LesserThanExpression__LhsAssignment_2");
			builder.put(grammarAccess.getLesserThanExpressionAccess().getRhsAssignment_4(), "rule__LesserThanExpression__RhsAssignment_4");
			builder.put(grammarAccess.getNotLogicalExpressionAccess().getOperandAssignment_2(), "rule__NotLogicalExpression__OperandAssignment_2");
	...
	@Override
	protected InternalMinotorDslParser createParser() {
		InternalMinotorDslParser result = new InternalMinotorDslParser(null);

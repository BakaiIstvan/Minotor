...
public class ChangeToMessages {
  public CharSequence compile_changeto_required(final ChangeToMessage cm) {
    ...
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"");
    String _name_6 = cm.getContext().getName();
    _builder.append(_name_6);
    _builder.append("\" + \".\" + \"");
    String _name_7 = cm.getEntity().getName();
    _builder.append(_name_7);
    _builder.append("\" + \".\" + \"");
    String _name_8 = cm.getAttribute().getName();
    _builder.append(_name_8);
    _builder.append(", ");
    AttributeValue _changevalue_2 = cm.getChangevalue();
    _builder.append(_changevalue_2);
  ...
  public CharSequence compile_changetor_required(final ChangeToRelation cm) {
    ...
    _builder.append(_name_6);
    _builder.append("\" + \".\" + \"");
    String _name_7 = cm.getRelation().getName();
    _builder.append(_name_7);
    _builder.append("\" + \".\" + \"");
    String _name_8 = cm.getAttribute().getName();
    _builder.append(_name_8);

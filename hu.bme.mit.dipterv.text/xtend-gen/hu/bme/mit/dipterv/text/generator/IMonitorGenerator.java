...
public class IMonitorGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource input, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("private IClock clock;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.newLine();
    _builder_1.append("\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t ");
    _builder_1.append(", IClock clock) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("this.clock = clock;");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t");
    _builder_1.append("if (!transitions.stream().anyMatch(t -> t.getId().contains(\"epsilon\"))) {");
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t\t");
    _builder_1.append("iterator = transitions.listIterator();");
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t\t");
    _builder_1.append("} else if (transition.hasClock()) {");
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t");
    _builder_1.append("if (transition.clockConditionSatisfied(clock.getClock(transition.getClock()))) {");
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("System.out.println(\"transition triggered: \" + transition.getId());");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("if (transition.hasReset()) {");
    _builder_1.newLine();
    _builder_1.append("\t\t\t");
    _builder_1.append("clock.resetClock(transition.getReset());");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("}");
    _builder_1.newLine();

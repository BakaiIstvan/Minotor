...
class DiagramGenerator extends AbstractGenerator {
	...
	'''Name="«new LabelGenerator().compile_message_xml(m)»" Type="REGULAR" Label="e: «new LabelGenerator().compile_message_xml(m)»" isStrict="true" source="//@lifelines.«compile_message_source(m, domain)»" target="//@lifelines.«compile_message_target(m, domain)»" «IF transitionCounter > 0»before="//@transitions.«transitionCounter - 1»"«ENDIF» «IF transitionCounter < domain.scenarios.get(0).scenariocontents.size()»after="//@transitions.«transitionCounter + 1»"«ENDIF» «IF m.message.get(0).resetclock !== null»reset="«m.message.get(0).resetclock.clock.name»"«ENDIF» «IF m.message.get(0).CConstraint !== null»clockConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.message.get(0).CConstraint)»"«ENDIF»'''
	
	def dispatch generateMessage(PastMessage m, Domain domain)
	'''Name="«new LabelGenerator().compile_message_xml(m)»" Type="REGULAR" Label="e: «new LabelGenerator().compile_message_xml(m)»" source="//@lifelines.«compile_message_source(m, domain)»" target="//@lifelines.«compile_message_target(m, domain)»" «IF transitionCounter > 0»before="//@transitions.«transitionCounter - 1»"«ENDIF» «IF transitionCounter < domain.scenarios.get(0).scenariocontents.size()»after="//@transitions.«transitionCounter + 1»"«ENDIF» constraint="//@constraints.«domain.constraints.indexOf(m.c)»" constraintType="PAST" «IF m.constraintexp != null»clockOnConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.constraintexp)»"«ENDIF» «IF m.resetinconstraint != null»resetOnConstraint="«m.resetinconstraint.clock.name»"«ENDIF» «IF m.message.get(0).resetclock !== null»reset="«m.message.get(0).resetclock.clock.name»"«ENDIF» «IF m.message.get(0).CConstraint !== null»clockConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.message.get(0).CConstraint)»"«ENDIF»'''
	
	def dispatch generateMessage(FutureMessage m, Domain domain)
	'''Name="«new LabelGenerator().compile_message_xml(m)»" Type="REGULAR" Label="e: «new LabelGenerator().compile_message_xml(m)»" source="//@lifelines.«compile_message_source(m, domain)»" target="//@lifelines.«compile_message_target(m, domain)»" «IF transitionCounter > 0»before="//@transitions.«transitionCounter - 1»"«ENDIF» «IF transitionCounter < domain.scenarios.get(0).scenariocontents.size()»after="//@transitions.«transitionCounter + 1»"«ENDIF» constraint="//@constraints.«domain.constraints.indexOf(m.c)»" constraintType="FUTURE" «IF m.constraintexp != null»clockOnConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.constraintexp)»"«ENDIF» «IF m.resetinconstraint != null»resetOnConstraint="«m.resetinconstraint.clock.name»"«ENDIF» «IF m.message.get(0).resetclock !== null»reset="«m.message.get(0).resetclock.clock.name»"«ENDIF» «IF m.message.get(0).CConstraint !== null»clockConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.message.get(0).CConstraint)»"«ENDIF»'''
	
	def dispatch generateMessage(StrictFutureMessage m, Domain domain)
	'''Name="«new LabelGenerator().compile_message_xml(m)»" Type="REGULAR" Label="e: «new LabelGenerator().compile_message_xml(m)»" isStrict="true" source="//@lifelines.«compile_message_source(m, domain)»" target="//@lifelines.«compile_message_target(m, domain)»" «IF transitionCounter > 0»before="//@transitions.«transitionCounter - 1»"«ENDIF» «IF transitionCounter < domain.scenarios.get(0).scenariocontents.size()»after="//@transitions.«transitionCounter + 1»"«ENDIF» constraint="//@constraints.«domain.constraints.indexOf(m.futureMessage.get(0).c)»" constraintType="FUTURE" «IF m.futureMessage.get(0).constraintexp != null»clockOnConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.futureMessage.get(0).constraintexp)»"«ENDIF» «IF m.futureMessage.get(0).resetinconstraint != null»resetOnConstraint="«m.futureMessage.get(0).resetinconstraint.clock.name»"«ENDIF» «IF m.futureMessage.get(0).message.get(0).resetclock !== null»reset="«m.futureMessage.get(0).message.get(0).resetclock.clock.name»"«ENDIF» «IF m.futureMessage.get(0).message.get(0).CConstraint !== null»clockConstraint="«new ClockConstraintGenerator().compile_clockConstraintExpressionXML(m.futureMessage.get(0).message.get(0).CConstraint)»"«ENDIF»'''

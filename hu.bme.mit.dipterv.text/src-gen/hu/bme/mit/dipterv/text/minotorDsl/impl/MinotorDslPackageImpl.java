 ...
 * @generated
 */
public class MinotorDslPackageImpl extends EPackageImpl implements MinotorDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see hu.bme.mit.dipterv.text.minotorDsl.MinotorDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MinotorDslPackageImpl()
  {
    super(eNS_URI, MinotorDslFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link MinotorDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MinotorDslPackage init()
  {
    if (isInited) return (MinotorDslPackage)EPackage.Registry.INSTANCE.getEPackage(MinotorDslPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMinotorDslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MinotorDslPackageImpl theMinotorDslPackage = registeredMinotorDslPackage instanceof MinotorDslPackageImpl ? (MinotorDslPackageImpl)registeredMinotorDslPackage : new MinotorDslPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theMinotorDslPackage.createPackageContents();

    // Initialize created meta-data
    theMinotorDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMinotorDslPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MinotorDslPackage.eNS_URI, theMinotorDslPackage);
    return theMinotorDslPackage;
  }
   ...
   */
  @Override
  public MinotorDslFactory getMinotorDslFactory()
  {
    return (MinotorDslFactory)getEFactoryInstance();
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(objectEClass, hu.bme.mit.dipterv.text.minotorDsl.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getObject_Object(), this.getObjectType(), null, "object", null, 0, -1, hu.bme.mit.dipterv.text.minotorDsl.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getObject_Name(), ecorePackage.getEString(), "name", null, 0, 1, hu.bme.mit.dipterv.text.minotorDsl.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEqualsExpression_Rhs(), ecorePackage.getEString(), "rhs", null, 0, 1, EqualsExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getGreaterThanExpression_Rhs(), ecorePackage.getEString(), "rhs", null, 0, 1, GreaterThanExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLesserThanExpression_Rhs(), ecorePackage.getEString(), "rhs", null, 0, 1, LesserThanExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

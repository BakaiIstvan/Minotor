 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.ChangeMessageImpl#getDisappear <em>Disappear</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.ChangeMessageImpl#getAppear <em>Appear</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.ChangeMessageImpl#getChangeto <em>Changeto</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.ChangeMessageImpl#getChangetor <em>Changetor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChangeMessageImpl extends MinimalEObjectImpl.Container implements ChangeMessage
{
  ...
  {
    return MinotorDslPackage.Literals.CHANGE_MESSAGE;
  }
  ...
  public EList<DisappearMessage> getDisappear()
  {
    if (disappear == null)
    {
      disappear = new EObjectContainmentEList<DisappearMessage>(DisappearMessage.class, this, MinotorDslPackage.CHANGE_MESSAGE__DISAPPEAR);
    }
    return disappear;
  }
  ...
  public EList<AppearMessage> getAppear()
  {
    if (appear == null)
    {
      appear = new EObjectContainmentEList<AppearMessage>(AppearMessage.class, this, MinotorDslPackage.CHANGE_MESSAGE__APPEAR);
    }
    return appear;
  }
  ...
  public EList<ChangeToMessage> getChangeto()
  {
    if (changeto == null)
    {
      changeto = new EObjectContainmentEList<ChangeToMessage>(ChangeToMessage.class, this, MinotorDslPackage.CHANGE_MESSAGE__CHANGETO);
    }
    return changeto;
  }
  ...
  public EList<ChangeToRelation> getChangetor()
  {
    if (changetor == null)
    {
      changetor = new EObjectContainmentEList<ChangeToRelation>(ChangeToRelation.class, this, MinotorDslPackage.CHANGE_MESSAGE__CHANGETOR);
    }
    return changetor;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MinotorDslPackage.CHANGE_MESSAGE__DISAPPEAR:
        return ((InternalEList<?>)getDisappear()).basicRemove(otherEnd, msgs);
      case MinotorDslPackage.CHANGE_MESSAGE__APPEAR:
        return ((InternalEList<?>)getAppear()).basicRemove(otherEnd, msgs);
      case MinotorDslPackage.CHANGE_MESSAGE__CHANGETO:
        return ((InternalEList<?>)getChangeto()).basicRemove(otherEnd, msgs);
      case MinotorDslPackage.CHANGE_MESSAGE__CHANGETOR:

 ...
 * </p>
 * <ul>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isInt <em>Int</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isFloat <em>Float</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isString <em>String</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isBoolean <em>Boolean</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isGreater <em>Greater</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isSmaller <em>Smaller</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isGreaterequals <em>Greaterequals</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isSmallerequals <em>Smallerequals</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isEquals <em>Equals</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#isNotequals <em>Notequals</em>}</li>
 *   <li>{@link hu.bme.mit.dipterv.text.minotorDsl.impl.FragmentAttributeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FragmentAttributeImpl extends MinimalEObjectImpl.Container implements FragmentAttribute
{
  ...
  {
    return MinotorDslPackage.Literals.FRAGMENT_ATTRIBUTE;
  }
  ...
  public void setInt(boolean newInt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__INT, oldInt, int_));
  }
  ...
  public void setFloat(boolean newFloat)
  {
    ...
    float_ = newFloat;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__FLOAT, oldFloat, float_));
  }
  ...
  public void setString(boolean newString)
  {
    ...
    string = newString;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__STRING, oldString, string));
  }
  ...
  public void setBoolean(boolean newBoolean)
  {
    ...
    boolean_ = newBoolean;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__BOOLEAN, oldBoolean, boolean_));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public void setGreater(boolean newGreater)
  {
    ...
    greater = newGreater;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__GREATER, oldGreater, greater));
  }
  ...
  public void setSmaller(boolean newSmaller)
  {
    ...
    smaller = newSmaller;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__SMALLER, oldSmaller, smaller));
  }
  ...
  public void setGreaterequals(boolean newGreaterequals)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__GREATEREQUALS, oldGreaterequals, greaterequals));
  }
  ...
  public void setSmallerequals(boolean newSmallerequals)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__SMALLEREQUALS, oldSmallerequals, smallerequals));
  }
  ...
  public void setEquals(boolean newEquals)
  {
    ...
    equals = newEquals;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__EQUALS, oldEquals, equals));
  }
  ...
  public void setNotequals(boolean newNotequals)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__NOTEQUALS, oldNotequals, notequals));
  }
  ...
  public NotificationChain basicSetValue(AttributeValue newValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE, oldValue, newValue);
  ...
  public void setValue(AttributeValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE, newValue, newValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__INT:
        return isInt();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__FLOAT:
        return isFloat();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__STRING:
        return isString();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__BOOLEAN:
        return isBoolean();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__NAME:
        return getName();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__GREATER:
        return isGreater();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__SMALLER:
        return isSmaller();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__GREATEREQUALS:
        return isGreaterequals();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__SMALLEREQUALS:
        return isSmallerequals();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__EQUALS:
        return isEquals();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__NOTEQUALS:
        return isNotequals();
      case MinotorDslPackage.FRAGMENT_ATTRIBUTE__VALUE:
        return getValue();
    }

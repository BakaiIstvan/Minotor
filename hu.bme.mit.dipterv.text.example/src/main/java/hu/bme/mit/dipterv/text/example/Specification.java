...
public class Specification{
	...
	public Specification(){
		...
		Automaton a = new Automaton("sendEmail");
		Automaton b;
		...
		+ "." + "server" + ")", actualState, actualState));
		...
		b.addTransition(new Transition("!(" + "computer" + "." +
			...
			+ "." + "server" + ")", actualState, acceptState));
		...
		b.addTransition(new Transition(str + " & " + "!(" + "computer" + "." +	
			"newEmail" + "("
			+ ")"
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException{
		...
		PrintWriter xmlWriter = new PrintWriter("Email" + ".xml", "UTF-8");
